  ...
  return (
    <div className='flex flex-col h-full bg-[url("/background.svg")] bg-no-repeat bg-cover items-center relative overflow-hidden'>
      <div className="flex flex-col justify-center items-start w-full px-28 py-28 gap-10 relative h-full">
        ...
        <div className="flex justify-start">
          <button
            ...
            onClick={onHome}
            type="button"
            className="py-8 px-10 z-20 me-2 w-[20rem] mb-2 text-4xl font-medium text-gray-900 focus:outline-none bg-transparent rounded-full border border-black-200 hover:bg-gray-100 hover:text-black-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 font-inter-custom"
          >
            Home
          </button>
        </div>
      ...
      <div className="absolute left-0 -bottom-36">
        <img src="/Astroninth.png" alt="Astroninth" srcset="" height={"100%"} draggable={true} />
      </div>
