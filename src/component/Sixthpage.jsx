...
function Sixthpage({ onNext,onHome }) {
  const options = [
  ...
  return (
    <div className='flex flex-col min-h-full bg-[url("/background.svg")] bg-no-repeat bg-cover items-center relative overflow-hidden text-black'>
      ...
      <div className="flex flex-col gap-16 font-inter-custom items-start w-full px-28 h-[40%]">
        ...
        {hasSelection && (
          <button
            onClick={handleNext}
            type="button"
            className="py-10 px-10 w-[20rem] text-4xl font-inter-custom font-medium text-gray-900 bg-transparent rounded-full border border-black/20 hover:bg-gray-100 hover:text-black focus:outline-none focus:ring-4 focus:ring-gray-100 transition"
          >
            Next
          </button>
        )}
       ...
       <div className="absolute left-0 bottom-0 flex">
        <img src="/rocket.svg" alt="sixth" />
      </div>
      <div className="absolute z-10 left-16  -bottom-[2%] flex">
