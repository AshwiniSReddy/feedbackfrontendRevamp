...
//             onClick={handleNext}
//             type="button"
//             className="py-10 px-10 w-[20rem] text-4xl font-medium text-gray-900 bg-transparent rounded-full border border-black/20 hover:bg-gray-100 hover:text-black focus:outline-none focus:ring-4 focus:ring-gray-100 transition"
//           >
//             Submit
//           </button>
//         </div>
