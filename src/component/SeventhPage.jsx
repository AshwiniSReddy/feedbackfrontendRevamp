  ...
  return (
    <div className='flex flex-col min-h-full bg-[url("/background.svg")] bg-no-repeat bg-cover items-center relative overflow-hidden text-black'>
      <div className="flex flex-col items-start w-full px-28 py-28 gap-10 relative">
        ...
        {/* Phone */}
        <div className="w-full max-w-3xl flex flex-col gap-6 mt-6 font-inter-custom ">
          <label className="text-2xl md:text-3xl lg:text-4xl font-semibold">Phone number</label>
          <div className="w-full border border-black rounded-2xl px-4 py-6">
            <input
              type="tel"
              value={phone}
              onChange={(e) => setPhone(e.target.value)}
              placeholder="98765 43210"
              className="w-full bg-transparent outline-none text-xl md:text-4xl"
            />
          </div>
          {phoneLooksBad && (
        ...
        {/* Email */}
        <div className="w-full max-w-3xl flex flex-col gap-6 mt-4 font-inter-custom">
          <label className="text-2xl md:text-3xl lg:text-4xl font-semibold">Email</label>
          <div className="w-full border border-black rounded-2xl px-4 py-6">
            <input
              type="email"
              value={email}
        ...
        <div className="mt-8">
          <button
            onClick={handleNext}
            type="button"
            className="py-10 px-10 w-[20rem] text-4xl font-medium rounded-full border
